...
**End-to-end test passed 2026-09-17** with info@theatlaslist.club as the applicant: live form → Supabase row → Airtable Contact + Event Ticket Request → Approved → MailerLite groups → automation "01 — Atlas Approved Guest" sent "Welcome to The Atlas List" → Guest Operations Confirmed → "Event — Desert After Dark Confirmed" → automation "03 — Desert After Dark Confirmed" sent "Confirmed — Desert After Dark, October 10" and queued its three date-based reminders (48 hours, know-before-you-arrive, tonight). Automations 02 and 04 were still disabled at the time.
