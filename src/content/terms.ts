export const terms = {
  ...
  intro:
    "These Terms of Service govern your use of the theatlaslist.club website (the \"Site\") and your participation in The Atlas List events and SMS program. By submitting an application or using the Site, you agree to these terms.",
  sections: [
    {
