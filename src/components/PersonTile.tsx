...
export function PersonTile({ name, handle, image, title, note, link = true }: Props) {
  return (
    <li className="flex items-start gap-4">
      <Avatar name={name} image={image} tone="dark" />
      <div className="flex flex-col items-start pt-1">
        ...
        {note && <span className="mt-2 font-serif italic text-base text-velvet-text">{note}</span>}
        <div className="mt-3">
